...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-screen overflow-hidden flex items-center pt-24 md:pt-18 mt-11">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-12 md:py-8 z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <h2 className="mt-6 max-w-lg text-slate-600 text-sm sm:text-base font-sm leading-relaxed">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
              <Link to="/contact" className="w-full sm:w-auto">
                <button className="group w-full flex items-center justify-center gap-3 bg-blue-600 text-white px-4 py-3 rounded-2xl text-sm sm:text-base font-bold uppercase tracking-wider hover:bg-black transition-all active:scale-95 shadow-lg">
                  Partner With Us
                  <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </button>
              </Link>
          ...
          <div className="relative w-full max-w-[520px] h-[480px] sm:h-[550px] flex items-center justify-center mx-auto mt-10 lg:mt-0">
            ...
            <div className="absolute top-8 right-1/2 translate-x-1/2 sm:right-4 sm:translate-x-0 z-30">
              <div className="bg-white/95 backdrop-blur-md rounded-[2rem] w-64 sm:w-72 p-6 border border-white shadow-xl">
                ...
                <h2 className="text-slate-600 text-[8px] font-bold uppercase mb-4">
            ...
            <div className="absolute bottom-26 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:-left-4 z-20">
              <div className="relative bg-white/70 backdrop-blur-xl rounded-[3rem] w-62 sm:w-[340px] py-6 px-6 border border-white/50 shadow-2xl">
                ...
                {/* Student Image */}
                <div className="hidden sm:block absolute -top-56 -left-14">
                  <div className="absolute inset-0 bg-blue-400/20 blur-[60px] rounded-full" />
                  <img src={heroStudent} alt="Student" className="relative w-92 z-30 drop-shadow-[0_20px_40px_rgba(0,0,0,0.2)]" />
                </div>
                ...
                <div className="mt-16 sm:mt-2">
                  ...
                  <h4 className="text-lg sm:text-xl font-[1000] text-slate-900 mb-4 uppercase tracking-tighter italic">Institutional Growth</h4>
